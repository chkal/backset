...
public class ServiceRefHandlerType {
    ...
    protected de.chkal.backset.module.jsp.xml.types.String handlerName;
    ...
    protected List<de.chkal.backset.module.jsp.xml.types.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<de.chkal.backset.module.jsp.xml.types.String> portName;
     ...
     * @return
     *     possible object is
     *     {@link de.chkal.backset.module.jsp.xml.types.String }
     *     
     */
    public de.chkal.backset.module.jsp.xml.types.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(de.chkal.backset.module.jsp.xml.types.String value) {
     ...
     * 
     */
    public List<de.chkal.backset.module.jsp.xml.types.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<de.chkal.backset.module.jsp.xml.types.String>();
        }
     ...
     * 
     */
    public List<de.chkal.backset.module.jsp.xml.types.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<de.chkal.backset.module.jsp.xml.types.String>();
        }
