 ...
 *         &lt;element name="ordering" type="{http://xmlns.jcp.org/xml/ns/javaee}orderingType"/>
 *       &lt;/choice>
...
public class WebFragmentType {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "name", namespace = "http://xmlns.jcp.org/xml/ns/javaee", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ordering", namespace = "http://xmlns.jcp.org/xml/ns/javaee", type = JAXBElement.class, required = false),
     ...
     * This is why there is not a <CODE>set</CODE> method for the nameOrDescriptionAndDisplayName property.
     * 
     * <p>
    ...
    public List<JAXBElement<?>> getNameOrDescriptionAndDisplayName() {
        if (nameOrDescriptionAndDisplayName == null) {
            nameOrDescriptionAndDisplayName = new ArrayList<JAXBElement<?>>();
        }
        return this.nameOrDescriptionAndDisplayName;
    }
