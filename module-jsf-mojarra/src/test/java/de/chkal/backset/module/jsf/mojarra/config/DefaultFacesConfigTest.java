package de.chkal.backset.module.jsf.mojarra.config;
...
public class DefaultFacesConfigTest {

  @Deployment(testable = false)
  public static JavaArchive createDeployment() {

    JavaArchive archive = ShrinkWrap.create(JavaArchive.class, "backset-test.jar")
        .addAsResource("default-faces-config.xml", "webapp/WEB-INF/faces-config.xml")
        .addAsResource("default-messages.properties", "Messages.properties")
        .addAsResource(
  ...
  @Test
  public void shouldProcessDefaultFacesConfig() throws IOException {
